...
public class CustomerAccountCompositeAPI {
	...
	public List<Customer> getAllCustomers() {
		...
		logger.log(Level.INFO, "Service Name:customer-account-management-service , API Name: getAllCustomers(), Message: Processing Request");
		return customerAccountManagementProcessor.getOperationsHandler().getAllCustomers();
	}
	
	public List<Customer> getAllCustomersFallback() {
		logger.log(Level.INFO, "Service Name:customer-account-management-service , API Name: getAllCustomersFallback(), Message: Processing Request");
		return customerAccountManagementProcessor.getFallbackOperationsHandler().getAllCustomersFallback();
	}
	...
	public List<Account> getAllAccounts() {
		logger.log(Level.INFO, "Service Name:customer-account-management-service , API Name: getAllAccounts(), Message: Processing Request");
		return customerAccountManagementProcessor.getOperationsHandler().getAllAccounts();
	}
	
	public List<Account> getAllAccountsFallback() {
		logger.log(Level.INFO, "Service Name:customer-account-management-service , API Name: getAllAccountsFallback(), Message: Processing Request");
		return customerAccountManagementProcessor.getFallbackOperationsHandler().getAllAccountsFallback();
	}
	...
	public List<CustomerAccountBean> getAllCustomerAccounts() {
		
		logger.log(Level.INFO, "Service Name:customer-account-management-service , API Name: getAllCustomerAccounts(), Message: Processing Request");	
		return customerAccountManagementProcessor.getOperationsHandler().getCustomerAccountDetails();
	}
	
	public List<CustomerAccountBean> getCustomerAccountDetailsFallback() {
		
		logger.log(Level.INFO, "Service Name:customer-account-management-service , API Name: getCustomerAccountDetailsFallback(), Message: Processing Request");	
		return customerAccountManagementProcessor.getFallbackOperationsHandler().getCustomerAccountDetailsFallback();
	}
